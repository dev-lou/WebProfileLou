...
const Comment = memo(({ comment, formatDate, index, isPinned = false }) => (
    <div 
        className={`px-4 pt-4 pb-2 rounded-xl border transition-all group hover:-translate-y-0.5 ${
            isPinned
                ? 'bg-gradient-to-r from-indigo-500/20 to-purple-500/20 border-indigo-500/50 hover:bg-gradient-to-r hover:from-indigo-500/30 hover:to-purple-500/30'
                : 'bg-gray-700/60 border-gray-500 hover:bg-gray-700/80'
        }`}
    >
        {isPinned && (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1000">
                ...
                <input
                    ...
                    className="w-full p-3 rounded-xl bg-gray-700/60 border border-gray-500 text-white placeholder-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all"
                    required
                />
            </div>
            ...
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1200">
                ...
                <textarea
                    ...
                    className="w-full p-4 rounded-xl bg-gray-700/60 border border-gray-500 text-white placeholder-gray-400 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all resize-none min-h-[120px]"
                    required
                />
            </div>
            ...
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1400">
                ...
                <div className="flex items-center gap-4 p-4 bg-gray-700/60 border border-gray-500 rounded-xl">
                    {imagePreview ? (
                        ...
                        <div className="w-full">
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-indigo-500/30 text-indigo-400 hover:bg-indigo-500/40 transition-all border border-dashed border-indigo-500/60 hover:border-indigo-500 group"
                            >
...
const Komentar = () => {
    ...
    return (
    <div className="w-full bg-gray-800/80 rounded-2xl backdrop-blur-xl border border-gray-600" data-aos="fade-up" data-aos-duration="1000">
