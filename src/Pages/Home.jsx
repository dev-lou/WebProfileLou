...
const WORDS = ["IT Student", "IT Technician", "Software Developer", "Web Developer"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Facebook, link: "https://www.facebook.com/LVBaroro" },
  { icon: Github, link: "https://github.com/LouHu3" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/lou-vincent-baroro-7b4a9630b/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Building responsive websites and apps with a focus on clean design, functionality, and modern technologies like React and Firebase.
                </p>
