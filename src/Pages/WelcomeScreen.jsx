...
const WelcomeScreen = ({ onLoadingComplete }) => {
  ...
  }, [onLoadingComplete, typewriterDone]);
  ...
  }, [typewriterDone, onLoadingComplete]);
          ...
          <div className="relative min-h-screen flex items-center justify-center px-4">
            <div className="w-full max-w-4xl mx-auto">
              ...
              >
                <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold space-y-2 sm:space-y-4">
                  <div className="mb-2 sm:mb-4">
                    <span data-aos="fade-right" data-aos-delay="200" className="inline-block px-2 text-white">
                      Welcome
                    </span>{' '}
                  ...
                  <div>
                    <span data-aos="fade-up" data-aos-delay="800" className="inline-block px-2 text-white">
                      Portfolio
                    </span>{' '}
                    <span data-aos="fade-up" data-aos-delay="1000" className="inline-block px-2 text-white">
                      Website
                    </span>
                  </div>
                </h1>
              ...
              <span className="text-white">
                <TypewriterEffect text="www.loubaroro.com" onComplete={() => setTypewriterDone(true)} />
              </span>
                  </div>
                </a>
              </motion.div>
